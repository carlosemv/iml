...
img_ = Image.open(_Path("boat.png")).convert("RGBA")
circle_ = Image.open(_Path("circle.png")).convert("RGBA")
rect_ = _scale((0.33, 0.33, 0.66, 0.66), (1080, 610))
cut_ = _rm_sec(img_, rect_)
cut_.show()
