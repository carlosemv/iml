...
public:
    ...
    static constexpr Token::t_type FOR_T = Lexer::LAST_T + 39;
    static constexpr Token::t_type ALL_T = Lexer::LAST_T + 40;
    static constexpr Token::t_type IN_T = Lexer::LAST_T + 41;
    static constexpr Token::t_type IMAGE_OP_T = Lexer::LAST_T + 42;
    static constexpr Token::t_type SAVE_T = Lexer::LAST_T + 43;
    static constexpr Token::t_type AS_T = Lexer::LAST_T + 44;
    static constexpr Token::t_type FLIP_T = Lexer::LAST_T + 45;
    static constexpr Token::t_type HORIZONTALLY_T = Lexer::LAST_T + 46;
    static constexpr Token::t_type VERTICALLY_T = Lexer::LAST_T + 47;
    static constexpr Token::t_type R_T = Lexer::LAST_T + 48;
    static constexpr Token::t_type G_T = Lexer::LAST_T + 49;
    static constexpr Token::t_type B_T = Lexer::LAST_T + 50;
    static constexpr Token::t_type MODIFY_T = Lexer::LAST_T + 51;
    static constexpr Token::t_type SHARPNESS_T = Lexer::LAST_T + 52;
    static constexpr Token::t_type BRIGHTNESS_T = Lexer::LAST_T + 53;
    static constexpr Token::t_type CONTRAST_T = Lexer::LAST_T + 54;
    static constexpr Token::t_type COLOR_T = Lexer::LAST_T + 55;
    static constexpr Token::t_type IMAGE_T = Lexer::LAST_T + 56;
    static constexpr Token::t_type DIMS_T = Lexer::LAST_T + 57;
    static constexpr Token::t_type SECTION_T = Lexer::LAST_T + 58;
    static constexpr Token::t_type FLOAT_T = Lexer::LAST_T + 59;
    static constexpr Token::t_type INT_T = Lexer::LAST_T + 60;
    static constexpr Token::t_type PATH_T = Lexer::LAST_T + 61;
    static constexpr Token::t_type NONE_T = Lexer::LAST_T + 62;
    static constexpr Token::t_type TYPE_T = Lexer::LAST_T + 63;
    static constexpr Token::t_type CALL_T = Lexer::LAST_T + 64;
    static constexpr Token::t_type UNMINUS_T = Lexer::LAST_T + 65;
    static constexpr Token::t_type SECTION_LIT_T = Lexer::LAST_T + 66;
    static constexpr Token::t_type DIMS_LIT_T = Lexer::LAST_T + 67;
    static constexpr Token::t_type DIMENSIONS_T = Lexer::LAST_T + 68;
    static constexpr Token::t_type PROG_T = Lexer::LAST_T + 69;
